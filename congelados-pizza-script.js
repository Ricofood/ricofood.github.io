...
let total = 0;
let contadorProductos = JSON.parse(localStorage.getItem('contadorProductos-congelados'));
...
function mantenerToppings(_tamano) {
        ...
        toppingOptions.forEach(function (topping) {
            if (topping.checked) {
                if (topping.id.includes("extra")) {
                    let toppingCocktail = document.getElementById('extra-cocktail');
                    toppingCocktail.checked = false;
                    ...
                    let toppingCocktail = document.getElementById('tomate-cocktail');
                    toppingCocktail.checked = false;
                    ...
                    let toppingCocktail = document.getElementById('cebolla-cocktail');
                    toppingCocktail.checked = false;
                    ...
                    let toppingCocktail = document.getElementById('pepperoni-cocktail');
                    toppingCocktail.checked = false;
                    ...
                    let toppingCocktail = document.getElementById('jamon-cocktail');
                    toppingCocktail.checked = false;
                    ...
                    let toppingCocktail = document.getElementById('tocino-cocktail');
                    toppingCocktail.checked = false;
                    ...
                    let toppingCocktail = document.getElementById('choclo-cocktail');
                    toppingCocktail.checked = false;
                    ...
                    let toppingCocktail = document.getElementById('champis-cocktail');
                    toppingCocktail.checked = false;
                    ...
                    let toppingCocktail = document.getElementById('aceitunas-cocktail');
                    toppingCocktail.checked = false;
                    ...
                    let toppingCocktail = document.getElementById('pimenton-cocktail');
                    toppingCocktail.checked = false;
    ...
    else if (_tamano === "cocktail") {
        toppingOptions.forEach(function (topping) {
            if (topping.checked) {
                if (topping.id.includes("extra")) {
                    let toppingCocktail = document.getElementById('extra-cocktail');
                    toppingCocktail.checked = true;
                    let toppingIndividual = document.getElementById('extra-individual');
                    toppingIndividual.checked = false;
                    let toppingMediana = document.getElementById('extra-mediana');
                    toppingMediana.checked = false;
                    let nuevoTopping = document.getElementById('extra-familiar');
                    nuevoTopping.checked = false;
                    calcularSubtotal();
                }
                else if (topping.id.includes("tomate")) {
                    let toppingCocktail = document.getElementById('tomate-cocktail');
...
tamanoOptions.forEach(option => {
    option.addEventListener('change', function () {
        if (option.value === "Individual") {
            ...
            document.getElementById('tipo-masa-cocktail').style.display = 'none';
            ...
            document.getElementById('toppings-cocktail').style.display = 'none';
            ...
            document.getElementById('salsas-base-cocktail').style.display = 'none';
        ...
        if (option.value === "Familiar") {
        ...
        else if (option.value === "Cocktail") {
            tamanoPizza = "Cocktail";
            document.getElementById('tipo-masa-individual').style.display = 'none';
            document.getElementById('tipo-masa-mediana').style.display = 'none';
            document.getElementById('tipo-masa-familiar').style.display = 'none';
            document.getElementById('tipo-masa-cocktail').style.display = 'block';
            document.getElementById('toppings-individual').style.display = 'none';
            document.getElementById('toppings-mediana').style.display = 'none';
            document.getElementById('toppings-familiar').style.display = 'none';
            document.getElementById('toppings-cocktail').style.display = 'block';
            document.getElementById('salsas-base-individual').style.display = 'none';
            document.getElementById('salsas-base-mediana').style.display = 'none';
            document.getElementById('salsas-base-familiar').style.display = 'none';
            document.getElementById('salsas-base-cocktail').style.display = 'block';
            tipoMasa.forEach(function (tipo) {
                if (tipo.checked) {

                    if (tipo.id.includes("delgada")) {
                        let nuevoTipo = document.getElementById('delgada-cocktail');
                        nuevoTipo.click();
                    }
                    else if (tipo.id.includes("tradicional")) {
                        let nuevoTipo = document.getElementById('tradicional-cocktail');
                        nuevoTipo.click();
                    }
                    else if (tipo.id.includes("gruesa")) {
                        let nuevoTipo = document.getElementById('gruesa-cocktail');
                        nuevoTipo.click();
                    }
                }
            });
            salsaOptions.forEach(function (salsa) {
                ...
                if (salsa.checked) {
                    ...
                    if (salsa.id.includes("bbq")) {
                        let nuevaSalsa = document.getElementById('bbq-cocktail');
                        nuevaSalsa.click();
                    }
                    else if (salsa.id.includes("tomate")) {
                        let nuevaSalsa = document.getElementById('salsa-tomate-cocktail');
                        nuevaSalsa.click();
                    }
                    else if (salsa.id.includes("crema")) {
                        let nuevaSalsa = document.getElementById('crema-cocktail');
                        nuevaSalsa.click();
                    }
                }
            });
            mantenerToppings("cocktail");
        }
    });
});
...
let pizza = { tipo: "", id: "", tamano: "", masa: "", toppings: [], salsa: "", subtotal: 0, valor: 0, unidades: 0 };
...
function clearPizza() {
    ...
    pizza = { tamano: "", masa: "", toppings: [], salsa: "", subtotal: 0, valor: 0, unidades: 0 };
    subtotal = 0;
    subtotalDisplay1.textContent = `Subtotal: $${subtotal}`;
    defaultPizza();
}
...
function agregarPizza() {
    ...
    localStorage.setItem('total-congelados', total + subtotal);
...
function agregarProducto(_producto, _subtotal, _toppings) {
    ...
    contadorProductos++;
    localStorage.setItem('contadorProductos-congelados', contadorProductos);
}
